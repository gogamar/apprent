  ...
  return (
    <div className="mt-6 flex items-center justify-end border-t border-gray-200 pt-4">
      <a
        ...
        className={`group ${textColor} relative inline-flex items-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 sm:text-sm font-semibold shadow-sm hover:bg-gray-100 hover:border-gray-400 focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 focus:outline-none transition`}
      >
